...
G1 X200 Y200 Z100 F1500 ; center extruder and raise bed.
...
G1 Z20 F1500 ; raise bed back to z 20mm from the nozzle
...
M291 P"Retract the Z Probe, if you're not going to re-run this macro. Press OK when done." S2