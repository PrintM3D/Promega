...
; Left Only T1
M563 P1 D0 H1 F2 S"Mixing as Single Left" ; mixing nozzle only using left extruder motor
M568 P1 S0 ; Turn off tool mixing
G10 P1 X0 Y0 Z0 ; Set axis offsets
G10 P1 R0 S0 ; Set active (S0) & standby temp (R0) at 0.

; Right Only T2
M563 P2 D1 H1 F2 S"Mixing as Single Right" ; mixing nozzle only using right extruder motor
